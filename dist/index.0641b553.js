...
async function buildLocalCache() {
    try {
        return (await (0, _axiosDefault.default).get("https://restcountries.com/v3.1/all")).data;
    } catch (e) {
        console.log(e);
    }
}
async function fetchCountry(requestedCountry) {
    ...
    for(let i = 0; i < countryArray.length; i++){
        if (countryArray[i].name.common === requestedCountry) return countryArray[i];
    }
}
async function constructCountryTile(country) {
    ...
    const { name: { common: commonName  } , flags: { png: flagPng , alt  } , region , population  } = await fetchedCountry;
...
var Buffer = require("39b0085e850f722e").Buffer;
"use strict";
/**
...
},{"39b0085e850f722e":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("7d2f4752afcd3256");
var ieee754 = require("fb4d60da171b7d5b");
...
},{"7d2f4752afcd3256":"eIiSV","fb4d60da171b7d5b":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
